...
<template>
    <div class="relative flex h-svh flex-col items-center justify-center overflow-hidden">
        <Plasma class="hidden md:block" :color="primaryColor" :speed="1.2" direction="reverse" :scale="0.9"
            :opacity="0.8" :mouseInteractive="false" />
        <div
