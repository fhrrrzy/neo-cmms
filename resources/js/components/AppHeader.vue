            ...
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <div class="ml-auto flex items-center space-x-2">
                    <div class="relative flex items-center space-x-1">
                        <Button variant="ghost" class="group inline-flex h-9 items-center gap-2 px-3"
                            @click="handleSearchClick">
                            <Search class="h-4 w-4 opacity-80 group-hover:opacity-100" />
                            <KbdGroup>
                                <Kbd>{{ modKeyLabel }}</Kbd>
                                <Kbd>K</Kbd>
                            </KbdGroup>
                            ...
                            <Button variant="ghost" size="icon"
                                ...
                                <Avatar class="size-8 overflow-hidden rounded-full">
                                    ...
                                    <AvatarFallback
                                        ...
                                        <BoringAvatar :name="auth.user?.name" variant="beam" />
                                    </AvatarFallback>
                                </Avatar>
                            </Button>
                        </DropdownMenuTrigger>
