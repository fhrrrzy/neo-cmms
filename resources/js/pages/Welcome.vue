        ...
        <nav class="fixed top-0 z-50 w-full border-b border-border bg-background/50 backdrop-blur-md">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                ...
                <div class="hidden items-center gap-8 md:flex">
                    <a href="#" class="text-muted-foreground transition hover:text-foreground">Product</a>
                    <a href="#" class="text-muted-foreground transition hover:text-foreground">Features</a>
                </div>
                <div class="flex items-center gap-4">
                    <Link :href="login()" class="text-muted-foreground transition hover:text-foreground">
                    Log in
                    </Link>
                    <Link :href="login()"
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="relative z-10 grid items-center gap-12 md:grid-cols-2">
                    ...
                    <motion.div :initial="{ opacity: 0, y: 20 }" :animate="{ opacity: 1, y: 0 }"
                        ...
                        <div class="mb-6 inline-block rounded-full border border-border bg-muted/50 px-4 py-2">
                            <span class="text-sm text-primary">Real-time Equipment Monitoring</span>
                        </div>
                        ...
                        <h1 class="mb-6 text-5xl leading-tight font-bold md:text-6xl">
                            ...
                            <br />
                            <span class="text-foreground">Keep Production Running</span>
                        </h1>
